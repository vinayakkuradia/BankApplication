...
<head>
<meta charset="UTF-8">
<title>Error 400: Not Found</title>
...
<body>
	 <section class="error_section">
      <p class="error_section_subtitle">Opps we couldn't find it!</p>
      ...
      <small class="text-secondary">You'll be soon redirected to homepage</small>
    </section>
	<script>
